        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <p className="text-sm text-blue-800">
              Running these premium AI models costs real money. Each comparison uses multiple API calls that I pay for
              to keep this free for everyone.
            </p>
          </div>

          <p className="text-gray-700">
            If you find this tool helpful, consider buying me a coffee to help cover the API costs and keep improving
            the platform! ☕
          </p>
        </div>
